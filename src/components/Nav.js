const Nav = () => {
  return (
    <nav
      className="fixed bg-gray-500 lg:bg-transparent lg:absolute z-10 p-5 
        min-w-full flex justify-center"
    >
      <div className="w-[100%] max-w-[1368px] flex justify-between max-w-full">
        ...
        <div className="flex items-center justify-center gap-4 lg:gap-11">
          ...
          <a className="gap-3 hidden lg:flex">
            Services
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
